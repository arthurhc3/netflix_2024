		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projetonetflixabap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projetonetflixabap-display": {
								"semanticObject": "projetonetflixabap",
								"action": "display",
								"description": "FioriNET Jornada Programador ABAP do Zero",
								"title": "Projeto Netflix",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projetonetflixabap",
									"url": sap.ui.require.toUrl("projetonetflixabap")
								}
							}
						}
					}
